;;; kl_color-theme-zenburn.el --- A low contrast color theme for Emacs.
...
;; [KL 2011-12-25] make the bg greys just a wee bit darker
...
;     (trailing-whitespace ((t (:background ,zenburn-red))))
     (trailing-whitespace ((t (:background ,zenburn-bg))))
...
(provide 'kl_color-theme-zenburn)

;;; kl_color-theme-zenburn.el ends here.
